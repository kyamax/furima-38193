class Item < ApplicationRecord
  ...
  validates :price, inclusion: { in: 300..9999999, message: "is out of setting range" }, numericality: { only_integer: true, message: "is invalid. Input half-width characters" }
